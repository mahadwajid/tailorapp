            ...
            <div data-aos="fade-left" className="bg-white rounded-[20px] p-8 shadow-md">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#9A54FD]/10 flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-[#9A54FD]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-satoshi text-[15px] text-gray-900 font-medium mb-1">
